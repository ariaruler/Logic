...
\begin{theorem}
    ...
    \begin{fitchproof}[arrayenv=tabular]
        ...
        \have  [m] {2} {\varphi}
        \close
        \have  [m+1] {2} {\varphi \to \psi }                              \by{$I\to,1,n$ }{}
        \have  [m+2] {2} {\psi \to \varphi }                              \by{$I\to,n+1,m$}{}
        \have  [m+3] {2} {(\varphi \to \psi)\land (\psi \to \varphi)}     \by{$I\land,m+1,m+2$}{}
        \have  [m+4]{2} {\varphi \leftrightarrow \psi}                     \by{$Def.,m+3$ }{}
    \end{fitchproof}

    \begin{fitchproof}[arrayenv=tabular]
        \have {1} {\varphi \leftrightarrow \psi }
        \have {2} {\varphi }
...
\begin{theorem}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{7cm}>{\centering\arraybackslash}m{7cm}}
        \begin{fitchproof}[arrayenv=tabular]
            ...
            \have [n+1] {2} {\bigwedge\limits_{i=0}^n \Phi a_{i} }          \by{$I\land,2,3,...,n+2$}{}
            \have  [n+2]{2} { \forall x \Phi x}                  \by{$Def. n+3$ }{}
        \end{fitchproof}
         &
        \begin{fitchproof}[arrayenv=tabular]
...
\begin{axiom}
    ...
    There exists a set $V$, known as the Von Neumann Universe, which contains every set.
...
\begin{theorem}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{7cm}>{\centering\arraybackslash}m{7cm}}
        \begin{fitchproof}[arrayenv=tabular]
            ...
            \have  [n] {2} {x \in B}
            \close
            \have  [n+1]{2} {x \in A \rightarrow x \in B }              \by{$I\rightarrow,1,n$ }{}
            \have  [n+2]{2} {\forall x(x \in A \rightarrow x \in B )}   \by{$I\forall,n+1$ }{}
            \have  [n+3]{2} {A \subseteq B  }                 \by{$Def.n+2$ }{}
        \end{fitchproof}
         &
        \begin{fitchproof}[arrayenv=tabular]
            \have {1} {A \subseteq B}
...
% \begin{sdeduce}
% \hyp[1] {P \rightarrow (Q \lor R)} & Assumption  \\
% \sub[1] {Q \rightarrow S}  & Assumption \\
% \sub[1] {R \rightarrow T}  & Assumption \\
% \hyp[2] {P}              & Assumption \\
% \sub[2] {Q \lor R}      & 1,4 $\rightarrow$E \\

% \hyp[3] {Q}              & Assumption \\
% \sub[3] {S}              & 2,6 $\rightarrow$E \\
% \sub[3] {S \lor T}       & 7 $\lor$I \\

% \hyp[3] {R}              & Assumption \\
% \sub[3] {T}             & 3,9 $\rightarrow$E \\
% \sub[3] {S \lor T}      & 10 $\lor$I \\

% \sub[2] {S \lor T}      & 5,6-8,9-11 $\lor$E \\

% \sub[1] {P \rightarrow (S \lor T)} & 4-12 $\rightarrow$I \\
