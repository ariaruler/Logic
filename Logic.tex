...
%
\begin{definition}
    \textbf{Atomic formula} every single obbject or two obj(conatants and variable) and a binary
...
\begin{example}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{5cm}|>{\centering\arraybackslash}m{5cm}|>{\centering\arraybackslash}m{5cm}}
        ...
        \begin{fitchproof}[arrayenv=tabular]
            ...
            \open
            \have {} {q} \by {$acp$} {}
            \have {} {p \land q} \by {$I \land 2,3$} {}
            \have {} {r} \by {$\to E  1,4$} {}
            \close
            \have {} {q \to r} \by {$I \to 3,5$} {}
            \close
            \have {} {p \to (q \to r)} \by  {$I \to 2,6$} {}
        \end{fitchproof}
        \\
        \hline
    \begin{fitchproof}[arrayenv=tabular]
        ...
        \have{3}{p} \by{2, $\land$E}{}
        \have{4}{q \rightarrow r} \by{1,3, $\rightarrow$E}{}
        \have{5}{q} \by{2, $\land$E}{}
        \have{6}{r} \by{4,5, $\rightarrow$E}{}
        \close
        \have{7}{(p \land q) \rightarrow r} \by{2-6, $\rightarrow$I}{}
    ...
    \begin{fitchproof}[arrayenv=tabular]
        ...
        \open
        \have{2} {p} \by {E\(\land\) 1} {}
        \have{3} {q \lor r} \by {E\(\land\) 1} {}

        \open
        \have{4} {q} \by {acp} {}
        \have{5} {p \land q} \by {I\(\land\) 2,4} {}
        \have{6} {(p \land q) \lor (p \land r)} \by {I\(\lor\) 5} {}
        \close

        \open
        \have{7} {r} \by {acp} {}
        \have{8} {p \land r} \by {I\(\land\) 2,7} {}
        \have{9} {(p \land q) \lor (p \land r)} \by {I\(\lor\) 8} {}
        \close
        \have{9} {(p \land q) \lor (p \land r)} \by {I\(\lor\) 8} {}
        \close

        \have{10} {(p \land q) \lor (p \land r)} \by {E\(\lor\) 3,6,9} {}
...
\open
    ...
    \open
        \have{3}{p} \by{$acp$}{}
        \have{4}{p \lor (q \lor r)} \by{3, $\lor$I}{}
    \close
     \open
        \have{5}{q} \by{$acp$}{}
        \have{6}{q \lor r} \by{5, $\lor$I}{}
        \have{7}{p \lor (q \lor r)} \by{6, $\lor$I}{}
\close
   \have{8}{p \lor (q \lor r)} \by{2,4,7, $\lor$E}{}
\close
\open
    \have{9}{r} \by{$acp$}{}
    \have{10}{q \lor r} \by{9, $\lor$I}{}
    \have{11}{p \lor (q \lor r)} \by{10, $\lor$I}{}
\close
\have{12}{p \lor (q \lor r)} \by{1,8,11, $\lor$E}{}
\end{fitchproof}


\begin{fitchproof}[arrayenv=tabular]
    \have{1}{p \to q} \by{$assumption$}{}
    \open
        \have{2}{\neg p \lor q} \by{$acp$}{}
        \open
            \have{3}{p} \by{$acp$}{}
            \have{4}{q} \by{$E\to,1,3$}{}
            \have{5}{\neg p \lor q} \by{$I\lor,4$}{}
            \have{6}{\bot} \by{$E\neg,2,5$}{}
        \close
        \have{7}{\neg p} \by{$I\neg,3-6$}{}
        \have{8}{\neg p \lor q} \by{$I\lor,7$}{}
        \have{9}{\bot} \by{$E\neg,2,8$}{}
    \close
    \have{10}{\neg(\neg p \lor q)} \by{$RAA$}{2-9}
\end{fitchproof}

\begin{fitchproof}[arrayenv=tabular]
    \have {} {p \to q} \by {$assumption$} {}
    \have {} {\neg q} \by {$assumption$} {}
    \open
        \have {} {p} \by {$acp$} {}
        \have {} {q} \by {$E \to$} {}
...
\begin{theorem}
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{7.5cm}|>{\centering\arraybackslash}m{7.5cm}|}
        ...
        \begin{fitchproof}[arrayenv=tabular]
            ...
            \have  [ ]{2} {\therefore \Phi (a)} \by{$\forall E$}{}
        \end{fitchproof}
         &
        \begin{enumerate}
            \setlength{\itemsep}{0pt} % No extra space between items
...
\begin{theorem}
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{7.5cm}|>{\centering\arraybackslash}m{7.5cm}|}
        ...
        \begin{fitchproof}[arrayenv=tabular]
            \hypo [ ] {2} {\forall x \Phi (x)}
            \have  [ ]{2} {\therefore \Phi (t)} \by{$\forall E$}{}
        \end{fitchproof}
         &
        \begin{enumerate}
            \setlength{\itemsep}{0pt} % No extra space between items
...
\begin{theorem}
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{7.5cm}|>{\centering\arraybackslash}m{7.5cm}|}
        ...
        \begin{fitchproof}[arrayenv=tabular]
            ...
            \have  [ ] {2} {a \in A_i}
            \close
            \have  [ ]{2} {\therefore a \in \bigcap_{i \in I} A_i } \by{$\bigcap_{I} I$}{}
        \end{fitchproof}
         &
        \begin{fitchproof}[arrayenv=tabular]
            \hypo [ ] {2} {a \in \bigcap_{i \in I} A_i }
            \hypo [ ] {2} {n \in  I  }
            \have  [ ]{2} {\therefore  a \in  A_n} \by{$\bigcap_{I} E$}{}
        \end{fitchproof}
        \\
        \hline
        \begin{fitchproof}[arrayenv=tabular]
            \hypo [ ] {2} {a \in A_n  }
            \hypo [ ] {2} {n \in I  }
            \have  [ ]{2} {\therefore  a \in \bigcup_{i \in I} A_i } \by{$\bigcup_{I} I$}{}
        \end{fitchproof}
         &
        \begin{fitchproof}[arrayenv=tabular]
